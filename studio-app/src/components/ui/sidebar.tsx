...
export const AppSidebar: React.FC = () => {
  ...
  const getMenuItems = () => [
    ...
    },
    {
      ...
      icon: Users,
      subMenus: [
        { label: "students.directory", href: "/student-management/directory", icon: Contact },
        { label: "students.admissions", href: "/student-management/admissions", icon: UserPlus },
      ],
    },
    {
  ...
  { label: "navigation.reviews", href: "/staff-management/reviews", icon: Star },
    ...
    },
    {
      ...
      icon: UserSquare,
      subMenus: [
        { label: "support.courses", href: "/support-programs/courses", icon: BookCopy },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: BookOpen,
      subMenus: [
        { label: "examination.exams", href: "/examination/exams", icon: CalendarPlus },
        { label: "examination.results", href: "/examination/results", icon: ClipboardCheck },
        { label: "examination.gradebook", href: "/examination/gradebook", icon: NotebookText },
        { label: "examination.reportCards", href: "/examination/report-cards", icon: FileText },
      ],
    },
    {
      label: "events.title",
    ...
    },
    {
      ...
      icon: MessageSquare,
      subMenus: [
        { label: "communication.announcements", href: "/communication/announcements", icon: Megaphone },
        { label: "communication.messages", href: "/communication/messages", icon: MessageSquare },
      ],
    },
    {
      ...
      icon: Archive,
      subMenus: [
        { label: "resources.library", href: "/resources/library", icon: Library },
        { label: "resources.inventory", href: "/resources/inventory", icon: Archive },
      ],
    },
    {
      label: "finance.title",
      icon: Landmark,
      subMenus: [
        { label: "finance.fees", href: "/finance/fees", icon: Receipt },
        { label: "finance.expenses", href: "/finance/expenses", icon: TrendingDown },
        { label: "finance.reports.title", href: "/finance/reports", icon: BarChart },
        { label: "finance.reports.studentOutstanding", href: "/finance/reports/student-outstanding", icon: Users },
        { label: "finance.reports.staffPaymentDue", href: "/finance/reports/staff-payment-due", icon: Banknote },
      ],
    },
