...
export function AcademicPerformanceReport({ filters }: AcademicPerformanceReportProps) {
  const { toast } = useToast();
  const [isLoading, setIsLoading] = useState(true);
  const [selectedGrade, setSelectedGrade] = useState<string>(filters?.grade || "all");
