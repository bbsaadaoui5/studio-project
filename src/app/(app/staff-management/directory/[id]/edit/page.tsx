                ...
                <FormItem>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <Controller
                      ...
                      name="dateOfBirth"
                      render={({ field }) => (
                          <Select onValueChange={(val) => {const d = new Date(field.value || Date.now()); d.setFullYear(parseInt(val)); field.onChange(d);}} value={String(getYear(field.value || Date.now()))}>
                    ...
                    <Controller
                      ...
                      name="dateOfBirth"
                      render={({ field }) => (
                          <Select onValueChange={(val) => {const d = new Date(field.value || Date.now()); d.setMonth(parseInt(val)); field.onChange(d);}} value={String(getMonth(field.value || Date.now()))}>
                    ...
                    <Controller
                      ...
                      name="dateOfBirth"
                      render={({ field }) => (
                          <Select onValueChange={(val) => {const d = new Date(field.value || Date.now()); d.setDate(parseInt(val)); field.onChange(d);}} value={String(getDate(field.value || Date.now()))}>
